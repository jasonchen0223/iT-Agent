  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* 底部 */}
        {footer ? (
          <div className="p-4 border-t border-indigo-800/30 bg-indigo-950/50">
            {footer}
          </div>
        ) : (
          <div className="p-4 border-t border-indigo-800/30 bg-indigo-950/50 flex justify-end space-x-3">
