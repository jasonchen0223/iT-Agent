        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              <span className={`px-2 py-1 rounded-full text-xs ${getStatusBadgeClass(agent.status)}`}>
          ...
          <div className="ml-auto flex gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={() => router.push(`/collaboration/new?agent=${agent.id}`)}>
              开始会话
            </Button>
          </div>
        </div>
          ...
          <Card>
            ...
            {activeTab === 'capabilities' && (
              <>
                ...
                <CardContent className="space-y-6">
                  <div>
                    <h3 className="text-indigo-100 font-medium mb-3">专长领域</h3>
                  ...
                  <div>
                    <h3 className="text-indigo-100 font-medium mb-3">能力评分</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {agent.capability.map((cap: string, index: number) => (
                        <div key={index} className="p-4 bg-indigo-900/20 rounded-md">
                  ...
                  <div>
                    <h3 className="text-indigo-100 font-medium mb-3">参数设置</h3>
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <label className="text-indigo-100 block">温度系数</label>
                        <input 
                          type="range" 
                          min="0" 
                          max="100" 
                      ...
                      <div className="space-y-2">
                        <label className="text-indigo-100 block">最大令牌数</label>
                        <input 
                          type="number" 
                          defaultValue="4096" 
            ...
            {activeTab === 'prompts' && (
              <>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h3 className="text-indigo-100 font-medium mb-2">系统消息</h3>
                    <textarea
            ...
            {activeTab === 'tools' && (
              <>
                ...
                <CardContent className="space-y-4">
                  <p className="text-indigo-300/70 mb-4">选择该代理可以使用的工具</p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center p-3 bg-indigo-900/20 border border-indigo-800/30 rounded-md">
                      ...
                      <label htmlFor="tool-1" className="flex-1">
                        ...
                        <div className="text-indigo-300/70 text-sm">生成和修改代码的工具</div>
                      </label>
                    </div>
                    
                    <div className="flex items-center p-3 bg-indigo-900/20 border border-indigo-800/30 rounded-md">
                      <input type="checkbox" id="tool-2" className="mr-3" checked />
                      <label htmlFor="tool-2" className="flex-1">
                        <div className="text-indigo-100">网络搜索</div>
                        <div className="text-indigo-300/70 text-sm">允许代理搜索互联网获取信息</div>
                      </label>
                    </div>
                    ...
                    <div className="flex items-center p-3 bg-indigo-900/20 border border-indigo-800/30 rounded-md">
                      ...
                      <label htmlFor="tool-3" className="flex-1">
                        ...
                        <div className="text-indigo-300/70 text-sm">生成各种类型的图表</div>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-indigo-900/20 rounded-md">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-indigo-300/70 text-xs">30分钟前</span>
                      </div>
                      <p className="text-indigo-300/70 text-sm">参与了关于新功能开发的讨论</p>
                    </div>
                    
                    <div className="p-3 bg-indigo-900/20 rounded-md">
                      <div className="flex justify-between items-center mb-2">
                        <h3 className="text-indigo-100">需求分析</h3>
                        <span className="text-indigo-300/70 text-xs">2小时前</span>
                      </div>
                      <p className="text-indigo-300/70 text-sm">分析了用户需求并提供了功能建议</p>
                    </div>
                    ...
                    <div className="p-3 bg-indigo-900/20 rounded-md">
                      ...
                      <p className="text-indigo-300/70 text-sm">评审了产品原型并提供了改进意见</p>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {agent.status === TAgentStatus.IDLE ? (
                    ...
                    <div className="p-2 bg-indigo-900/20 rounded">
                      <p className="text-indigo-100 text-sm">正在分析项目需求</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-center">
                    <div className="p-2 bg-indigo-900/20 rounded">
                      <p className="text-2xl font-semibold text-indigo-100">24</p>
                      <p className="text-indigo-300/70 text-xs">完成任务</p>
                    </div>
                    <div className="p-2 bg-indigo-900/20 rounded">
                      <p className="text-2xl font-semibold text-indigo-100">14</p>
                      <p className="text-indigo-300/70 text-xs">协作次数</p>
                    </div>
                    <div className="p-2 bg-indigo-900/20 rounded">
                      <p className="text-2xl font-semibold text-indigo-100">3.2h</p>
                      <p className="text-indigo-300/70 text-xs">平均响应</p>
                    </div>
                    <div className="p-2 bg-indigo-900/20 rounded">
                      <p className="text-2xl font-semibold text-indigo-100">98%</p>
